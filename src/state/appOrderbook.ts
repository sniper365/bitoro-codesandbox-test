...
import { ORDERBOOK_LEVELS } from "../constants/orderbook";
...
export const selectBids = (state: RootState): number[][] => state.appOrderbookReducer.bids;
export const selectAsks = (state: RootState): number[][] => state.appOrderbookReducer.asks;
export const selectGrouping = (state: RootState): number => state.appOrderbookReducer.groupingSize;
export const selectMarket = (state: RootState): string => state.appOrderbookReducer.market;
